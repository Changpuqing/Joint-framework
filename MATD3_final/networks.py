...
class Actor(nn.Module):
    def __init__(self, args, agent_id):
        ...
        self.fc3 = nn.Linear(args.hidden_dim1, args.action_dim_n[agent_id])
    ...
    def forward(self, x):
        ...
        a = self.max_action * torch.sigmoid(self.fc3(x))
...
class Critic_MATD3(nn.Module):
    def __init__(self, args):
        ...
        self.fc5 = nn.Linear(args.hidden_dim, args.hidden_dim1)
        self.fc6 = nn.Linear(args.hidden_dim1, 1)
        if args.use_orthogonal_init:
            print("------use_orthogonal_init------")
            orthogonal_init(self.fc1)
            orthogonal_init(self.fc2)
