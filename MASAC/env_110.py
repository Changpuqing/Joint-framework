...
class EnvMove(object):
    def __init__(self,
        ...
        self.p_min = p_min
        self.rate_game = np.zeros(110)
        self.UE_max_no_game = 110
    ...
    def ue_position(self):
        ...
        for i in range(4):
            if i == 0:
                self.random_in_circle_se(35, self.BSs_radius, i) #第一个小基站内的用户
        ...
        # 初始化后第一次统计用户的cell信息
        self.UE_cell = np.zeros(110)  # 这里的ue-cell我理解为基站内用户的数量
        ...
        self.UE_cell_backup = np.zeros(110)
