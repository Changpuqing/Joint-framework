...
class gogogo:
    ...
    def run_utility(self):
        ...
        self.file1 = self.smooth(np.load(r'E:\A2500\新建文件夹\MASAC\MASAC_code_test\MATD3_energy_que_con.npy', allow_pickle=True, encoding="latin1"), self.inter, self.weight)
        ...
        plt.plot(x1, self.file1, color='indigo', linewidth=1.0, linestyle=':', label='MASAC')
        # 设置图例大小
